...
// MongoStorage handles MongoDB operations for code indexing
...
func (s *MongoStorage) AddFolder(path, description string) (*IndexedFolder, error) {
...
func (s *MongoStorage) RemoveFolder(folderID string) error {
	ctx := context.Background()
...
func (s *MongoStorage) GetFolder(folderID string) (*IndexedFolder, error) {
...
func (s *MongoStorage) GetFolderByPath(path string) (*IndexedFolder, error) {
	var folder IndexedFolder
...
func (s *MongoStorage) ListFolders() ([]*IndexedFolder, error) {
...
func (s *MongoStorage) UpdateFolderStatus(folderID, status, errorMsg string) error {
	update := bson.M{
		"$set": bson.M{
			"status": status,
		},
...
func (s *MongoStorage) UpdateFolderScanTime(folderID string, fileCount int) error {
	_, err := s.foldersCol.UpdateOne(
		context.Background(),
		bson.M{"_id": folderID},
		bson.M{
...
func (s *MongoStorage) UpsertFile(file *IndexedFile) error {
...
func (s *MongoStorage) GetFile(fileID string) (*IndexedFile, error) {
	var file IndexedFile
...
func (s *MongoStorage) GetFileByPath(path string) (*IndexedFile, error) {
	var file IndexedFile
...
func (s *MongoStorage) ListFiles(folderID string) ([]*IndexedFile, error) {
...
func (s *MongoStorage) UpsertChunk(chunk *FileChunk) error {
...
func (s *MongoStorage) GetChunk(fileID string, chunkNum int) (*FileChunk, error) {
	var chunk FileChunk
...
func (s *MongoStorage) ListChunks(fileID string) ([]*FileChunk, error) {
...
func (s *MongoStorage) DeleteFile(ctx context.Context, fileID string) error {
...
func (s *MongoStorage) GetIndexStatus() (*IndexStatus, error) {
	ctx := context.Background()
